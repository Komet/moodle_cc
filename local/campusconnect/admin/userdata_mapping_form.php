...
class campusconnect_userdata_mapping_form extends moodleform {
    ...
    protected function definition() {
        ...
        if ($this->_customdata['showexport']) {
            ...
            foreach (campusconnect_courselink::$validexportmappingfields as $fieldname) {
                ...
                $mform->addElement('html', '</td><td>');
                if (in_array($fieldname, campusconnect_courselink::$validpersontypes)) {
        ...
        if ($this->_customdata['showimport']) {
            ...
            foreach (campusconnect_courselink::$validimportmappingfields as $fieldname) {
                $mform->addElement('html', '<tr><td>');
