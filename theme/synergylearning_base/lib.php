...
/**
 * Library functions for the synergylearning_base theme
 *
...
/**
 * synergylearning_base theme post process function for CSS
 * @param string $css Incoming CSS to process
 * @param stdClass $theme The theme object
 * @return string The processed CSS
 */
function synergylearning_base_process_css($css, $theme) {
    ...
    $css = synergylearning_base_set_regionwidth($css, $regionwidth);
    ...
    $css = synergylearning_base_set_customcss($css, $customcss);
 ...
 * @return string
 */
function synergylearning_base_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function synergylearning_base_set_customcss($css, $customcss) {
